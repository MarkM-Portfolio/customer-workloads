locals {
  ...
  sg = {
    ...
    custom_smtp        = aws_security_group.ecosustainable_custom_smtp_sg.id
  }
  ...
  app = {
    ...
    GEN2ECOSMTP01 = {
      ...
      iam_instance_profile   = "SSMInstanceProfile"
      subnet_id              = local.subnet.app_a
      vpc_security_group_ids = [local.sg.baseline_app, local.sg.migration, local.sg.custom_smtp]
      root_block_device = [
        {
          encrypted             = true
          volume_type           = "gp3"
    ...
    GEN2ECOSQLINT01 = {
      ami                    = "ami-00c06ea250daa1a4f"
      # Previous instance_type          = "m5.large"
