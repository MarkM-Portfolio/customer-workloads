locals {
  ...
  sg = {
    ...
    custom_citrix      = data.aws_security_group.custom_citrix.id
  }
  ...
  dc = {
    DSAF05DCP01 = {
      ...
      vpc_security_group_ids = [local.sg.baseline_data, local.sg.migration, local.sg.custom_citrix]
      root_block_device = [
        {
          encrypted             = true
          volume_type           = "gp3"
  ...
  cc = {
    ...
    # Citrix Cloud Connector Decommission BY DHANANJAY CHANGE REFERENCE 7000062537 
/*    DSAF05CCP02 = {
      ami                    = "ami-030a28fdc9023ad21"
      instance_type          = "m5.large"
      iam_instance_profile   = "SSMInstanceProfile"
  ...
  app = {
    GEN2SFGDMZ01 = {
      ...
      vpc_security_group_ids = [local.sg.baseline_app,local.sg.migration, local.sg.custom_citrix]
      root_block_device = [
        {
          encrypted             = true
          volume_type           = "gp3"
    ...
    # Infor Sun 6.4 latest patch upgrade environment
    DSAF05SQLP01 = {
