...
This directory contains the Infrastructure for Kirkby tyres.
...
Clone the repository to your local system. Assume into the account and then run the following commands to deploy the resources:
...
The import script is used to import migrated resources into the terraform state
