...
module "patching" {
  ...
  schedule_london     = "cron(0 0 2 ? * TUE#3 *)"
  schedule_london_two = "cron(0 0 2 ? * TUE#3 *)"
}
  ...
  ingress_with_cidr_blocks = [
    {
      ...
      to_port     = 7080
      protocol    = "tcp"
      description = "PASUNITY Portal access"
      cidr_blocks = "38.90.157.0/24"
    },
    {
      from_port   = 7080
      to_port     = 7080
